<?php
require_once 'model/feriado.php';
...
class FeriadoController{
    ...
    public function Index(){
        require_once 'view/feriado.php';
    }
    public function GuardarF(){
        $fer = new Feriado();

        $fer->Feriadoid = $_REQUEST['feriadoid'];
        $fer->Feriadofecha = $_REQUEST['feriadofecha'];
        $fer->Feriadoobservacion = $_REQUEST['feriadoobservacion'];
        $fer->Feriadoactivo = 1;
