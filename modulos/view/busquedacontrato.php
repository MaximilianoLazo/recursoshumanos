...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
            ...
            <div class="col-xs-2 col-sm-2">
	            <div class="form-group">
	              <label for="CboTipoDeContrato" class="control-label">Tipo de Contrato:</label>
            ...
            <div class="col-xs-2 col-sm-2">
              <div class="form-group">
								<label for="txtsbasicodesde">SB Desde :</label>
								<input type="number" name="txtsbasicodesde" id="txtsbasicodesde" value="" class="form-control" required>
							</div>
	          </div>
            <div class="col-xs-2 col-sm-2">
              <div class="form-group">
								<label for="txtsbasicohasta">SB Hasta :</label>
								<input type="number" name="txtsbasicohasta" id="txtsbasicohasta" value="" class="form-control" required>
							</div>
	          </div>
						<div class="col-xs-2 col-sm-2">
  ...
  <!--<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>-->
	...
	<script>
        ...
        var sbasicohasta = jQuery("#txtsbasicohasta").val();
          ...
          "SBasicoDesde" : sbasicodesde,
          "SBasicoHasta" : sbasicohasta,
				...
				$.ajax({
					data:  params,
					url:   'view/busquedacontrato-respuesta.php',
					dataType: 'html',
					type:  'post',
					beforeSend: function () {
