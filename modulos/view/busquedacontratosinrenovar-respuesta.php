...
//$apellidoynombres = $_POST["RdoApellidoYNombres"];
//$nrodocumento = $_POST["RdoNroDocumento"];
...
<?php
$contratos = $empleado->ListarContratosSinRenovar($secretaria, $tipodecontrato, $ordenci);
  ...
  jQuery(document).ready(function(){
    ...
    jQuery("#BtnListarContratos").click(function(){
      ...
      $.ajax({
        ...
        type: 'POST',
        //dataType:"html",
        url: 'includes/pdf/contratosinrenovar-listado.php',
        //contentType: false,
        //processData: false,
        data: params,
        //xhrFields is what did the trick to read the blob to pdf
