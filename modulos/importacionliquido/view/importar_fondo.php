...
<body>
	...
	<!--**********ventanas modal***********-->
	<?php include("includes/mdl/banco-bersa-creditos-importarfondo.php");?>
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Importar Fondo Voluntario IOSPER</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							...
							<h5 class="text-blue">Importar Fondo  -  <?php echo substr($periodomax->periodo_presentismo_f,5,2) .'/'.substr($periodomax->periodo_presentismo_f,0,4); ?></h5>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<?php $recibosdatos = $this->model->ListarFondo($periodomax->periodo_id) ;
									...
									<button type="button"
													...
													data-toggle="modal"
													data-target="#BancoBersaCredImportarFondo"
													data-titulo="<?php echo "Importar Fondo Voluntario"; ?>">
													IMPORTAR FONDO VOLUNTARIO
									</button>
									<?php } ?>
