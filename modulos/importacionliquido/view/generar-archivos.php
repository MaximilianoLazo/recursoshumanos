				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							...
							<h5 class="text-blue">Generar Archivos Externos - <?php echo substr($periodomax->periodo_presentismo_f,5,2) .'/'.substr($periodomax->periodo_presentismo_f,0,4); ?></h5>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<div align="right">
									...
									if($cantidadrecibos!=0){ ?>
										<a  class="btn btn-success" href="?c=importacion&a=IOSPERDescargar">IOSPER</a>
										<a  class="btn btn-success" href="?c=importacion&a=LEY3011Descargar">LEY 11049 (SISER)</a>
										<a  class="btn btn-success" href="?c=importacion&a=SEGUDescargar">SEGURO</a>
										<a  class="btn btn-success" href="?c=importacion&a=BERSADescargar">BERSA</a>
										<a  class="btn btn-success" href="?c=importacion&a=ACTIVOSDescargar">ACTIVOS</a>
										<a  class="btn btn-success" href="?c=importacion&a=PASIVOSDescargar">JUBILADOS</a>
								<?php }?>
