...
<body>
	...
	<?php include("includes/mdl/banco-bersa-creditos-importar-cuil.php");?>
								...
								<?php
									if($cantidadrecibos!=0){				?>
										...
										foreach($recibosdatos as $row):  							 	?>
													<?php if($i<>$row->legajo_id){ ?>
														<tr>
															...
															<th><?php if($subt!=0){echo $subt;} ?></th>
														</tr>
													<tr>
														<th><?php echo $row->cjmdg_personal_nroleg2. "-".$row->legajo_apellido.",".$row->legajo_nombres; ?></th>
													</tr>
													<tr>
														<td><?php echo $row->cjmdg_detsueldo_detconcep; ?></td>
														<?php
														if($row->impacto=='+'){?>
															<td><?php echo $row->cjmdg_detsueldo_importe; $subt=0;$subt=$subt+$row->cjmdg_detsueldo_importe;$c=$c+$row->cjmdg_detsueldo_importe; ?></td>
														<?php }else{ ?>
															<td><?php echo '-'.$row->cjmdg_detsueldo_importe;$subt=0;$subt=$subt+$row->cjmdg_detsueldo_importe; $c=$c-$row->cjmdg_detsueldo_importe; ?></td>
														<?php } ?>
														<td></td>
										...
										<?php } $i=$row->legajo_id; endforeach; ?>
												<tr>
													<td><?php echo "TOTAL A LIQUIDAR"; ?></td>
													<td><?php echo $c; ?></td>
													<td></td>
												</tr>
								 <?php } ?>
