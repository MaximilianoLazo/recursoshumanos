              ...
              <?php
                if($cantidadrecibos!=0){?>
                 ...
                 <tr>
                     ...
                     <th><?php if($row->liqcod_jub_id==600){echo $row->liq_det_importe;} //if($rem!=0){echo $rem;} ?></th>
                     <th><?php if($row->liqcod_jub_id==601){echo $row->liq_det_importe;}//if($desc!=0){echo $desc;} ?></th>
               </tr>
               <tr>
                   <th></th>
                   <th></th>
