						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Importar Liquidación</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							...
							<h5 class="text-blue">Importar Liquido - Periodo: <?php echo substr($periodomax->periodo_presentismo_f,5,2) .'/'.substr($periodomax->periodo_presentismo_f,0,4); ?></h5>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<div align="right">
								<?php $recibosdatos = $this->model->ListarSueldos($periodomax->periodo_id) ;
									...
									<button type="button"
													...
													data-titulo="<?php echo "Importar Liquido"; ?>">
													IMPORTAR LIQUIDO
									</button>
									...
									<button type="button"
													class="btn btn-primary"
													data-toggle="modal"
													data-target="#BancoBersaCredImportarCuil"
													data-titulo="<?php echo "Importar Liquido"; ?>">
													Calcular Cuil
									</button>
									-->
									...
									if($cantidadrecibos!=0){				?>
										...
										foreach($recibosdatos as $row):  							 	?>
													...
													<tr>
														...
														<td><?php if($row->impacto=='-'){echo '-'.$row->liq_det_importe;$c=0;$c=$c-$row->liq_det_importe;}else{echo $row->liq_det_importe;$c=0;$c=$c+$row->liq_det_importe;} ; ?></td>
													</tr>
												<?php }else{ ?>
												<tr>
													<td><?php echo $row->liqcod_jub_id . "-". $row->liqcod_nombre; ; ?></td>
													<td><?php if($row->impacto=='-'){echo '-'.$row->liq_det_importe;$c=$c-$row->liq_det_importe;  }else{echo $row->liq_det_importe;$c=$c+$row->liq_det_importe;  };  ?></td>
												</tr>
