...
<body>
	...
	<!--**********ventanas modal***********-->
	<?php include("includes/mdl/liquidacion-importar.php");?>
	<?php include("includes/mdl/liquidacion-codigo-importar.php");?>
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Listados de Liquidacion</h5>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								-->
									...
									<a  class="btn btn-success" href="?c=liquidacion&a=SeguroDeVidaDescargar">Seguro de Vida</a>
									<button type="button"
													class="btn btn-primary"
													data-toggle="modal"
													data-target="#CodigoLiqImportar"
													data-titulo="<?php echo "Importar Codigo de Liquidacion"; ?>">
													IMPORTAR C/liquidacion
									</button>
									<button type="button"
													class="btn btn-primary"
													data-toggle="modal"
													data-target="#LiquidacionesImportar"
													data-titulo="<?php echo "Importar Listado de Liquidacion"; ?>">
	...
	<script src="includes/js/liquidacion-importar.js"></script>
