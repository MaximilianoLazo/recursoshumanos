...
$fec_pantalla = date("d/m/Y", strtotime($recibosdatos_emp->legajo_fecing));
//$mes_pago=date("m",strtotime($per->periodo_hsext_jor_f));
//$mes_pago=date("%B",strftime($per->periodo_hsext_jor_f));
//$mes_pago= $m->format('F');
...
//------MPDF--------------
require_once __DIR__  . '../../../../../src/plugins/arielcr/src/NumerosALetras.php';
...
<table style="width=100%">
  <tr>
    <td style="width: 50%;">
              ...
              <tr>
                <td>
                  <table style="width:100%;border: 1px solid;border-collapse:collapse;border-padding:5px">
                    <tr>
                  ...
                  <table style="width:100%;border: 1px solid;border-collapse:collapse;">
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid" align="center"><strong>'.$fec_pantalla.'</strong></td>
                        <td style="border: 1px solid" aling="center"><strong>'.$recibosdatos_emp->legajo_id.'</strong></td>
                    </tr>
                  </table>

                 <table style="width:100%;padding:5px;border: 1px solid;border-collapse:collapse;margin-bottom: 10px">
                   <tr>
                   ...
                   <tr>
                       ...
                       <th style="border: 1px solid;" align="center">'.strftime("%B", strtotime("$per->periodo_hsext_jor_f")).'</th>
                   </tr>
                   <tr>
                    <th style="border: 1px solid;" align="center"><strong></strong></th>
                     <th style="border: 1px solid;" align="center"><strong>N° CUENTA</strong></th>
                     <th style="border: 1px solid;" align="center"><strong>FECHA DE PAGO</strong></th>
                   </tr>
                   <tr>
                     <th></th>
                     <th style="border: 1px solid;" align="center"><strong>'.$recibosdatos_emp->sucursal."-".$recibosdatos_emp->numero_cuenta.'</strong></th>
                     <th style="border: 1px solid;" align="center"><strong>'.date("t-m-Y", strtotime("$per->periodo_hsext_jor_f")).'</strong></th>
                   </tr>
                 </table>
                 <br>

                 <table style="width:100%;padding:25px;border: 1px solid;border-collapse:collapse" >
                    <thead>
                    ...
                    <tbody>';
                          ...
                          elseif($row->liqcod_jub_id==601){$neg=$row->liq_det_importe;};
                          if($row->liqcod_jub_id<>600 and $row->liqcod_jub_id<>601){
                            $html.='<tr><td style="border: 0px solid" height="15px" align="center">'.$row->liqcod_jub_id.'</td>
                            <td style="border: 0px solid">'.$row->liq_det_detconcep.'</td>';
                                if($row->impacto=="+"){
                                     $html.='<td style="border: 0px solid" align="right">'.$row->liq_det_importe.'</td>
                                             <td style="border: 0px solid"></td></tr>';
                                  }else{
                                     $html.='<td style="border: 0px solid"></td>
                                            <td style="border: 0px solid" align="right">'.$row->liq_det_importe.'</td></tr>';
                                  }
                                }
                              };$tot=$pos-$neg;
                           $html.='<tr style="border: 0px solid">
                           <th style="border: 0px solid" height="400px"></th>
                           ...
                           <tr style="border: 1px solid">
                               <th rowspan="2">Recibí conforme el importe neto de esta liquidación por el período arriba indicado, dejando constancia de haber recibido copia fiel de este recibo</th>
                           ...
                           <tr style="border: 1px solid">
                               ...
                               <th style="border: 1px solid" align="right">'.$tot.'</th>
                           </tr>

                    </tbody>
                 </table>

                 <table style="width:100%;padding:25px;border-collapse:collapse">
                 <tr>
                   <th>SON PESOS</th>';
                   list($sbasicoe, $sbasicod) = explode(".", $tot);
                   if($sbasicod > 0){
                     $sbasiconum = number_format($tot, 2, ',', '.');
                     $totalletra = NumerosALetras::convertir($sbasicoe);
                     $totalletra = $totalletra." CON ".$sbasicod."/100";
                   }else{
                     $sbasiconum = number_format($tot, 0, ',', '.');
                     $totalletra = NumerosALetras::convertir($sbasicoe);
                   };
                   $html.='<th>'.$totalletra.'</th>
                   <th></th>
                   <th></th>
                 </tr>
                 <tr>
...
$mpdf->Output(strftime("%B",strtotime("$per->periodo_hsext_jor_f"))."_".$recibosdatos_emp->legajo_apellido ."_".$recibosdatos_emp->legajo_nombres.".pdf", 'I');
exit;
