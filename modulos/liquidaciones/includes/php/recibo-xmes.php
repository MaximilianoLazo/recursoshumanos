                ...
                if($cantidadrecibos!=0){?>
                  ...
                  foreach($recibosdatos as $row):                 ?>
                      <tr>
                        ...
                        <td><?php if($row->impacto=='+'){echo $row->liq_det_importe; };if($row->liqcod_jub_id==600){$pos=$row->liq_det_importe;}  ?></td>
                        <td><?php if($row->impacto=='-'){echo '-'.$row->liq_det_importe;};if($row->liqcod_jub_id==601){$neg=$row->liq_det_importe;}?></td>
                      </tr>
                  <?php endforeach;?>
