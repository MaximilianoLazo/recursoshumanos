<form id="frm-conyugeagregar" action="?c=liquidacion&a=ReciboDescargarPruebaxmes" method="post" enctype="multipart/form-data">
<div class="modal fade bd-example-modal-lg" id="dataTableViewReciboxmes" name="dataTableViewReciboxmes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
										...
										<input type="text" id="reciboxmes" name="reciboxmes">
                    ...
                    <div class="col-md-12">
                      <div id="no-more-tables">
                          <div class="table-wrapper-scroll-y my-custom-scrollbar">
                            ...
                            <tr>
                              <th><?php echo "REPARTICION1  CAJA DE JUBILACIONES Y PENSIONES DE LA MUNICIPALIDAD DE GUALEGUAY" . "<br>". "DOMICILIO 1er.ENTRERRIANO N° 90 - GUALEGUAY -  ENTRE RIOS " ; ?></th>
