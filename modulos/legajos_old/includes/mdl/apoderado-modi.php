<form id="" action="?c=legajo&a=ApoderadoModificar" method="post" enctype="multipart/form-data">
    <div class="modal fade" id="ApoderadoModificar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
