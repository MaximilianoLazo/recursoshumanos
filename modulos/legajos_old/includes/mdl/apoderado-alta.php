<form id="" action="?c=legajo&a=ApoderadoAlta" method="post" enctype="multipart/form-data">
    <div class="modal fade" id="ApoderadoAlta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
