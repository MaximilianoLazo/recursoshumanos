...
<td style="text-align: right;" rowspan="2"><img src="../../../../src/images/personal-datos.png" width="200px" /></td>
  ...
  $datossecretaria = $contratol->ObtenerSecretaria($secretaria);
$html .='
<p>Total de contratos en '.$datossecretaria->secretaria_nombre.': '.$contratosc.'</p>
  <table border="1">
    <tr>
      <th>N&deg; DOC</th>
    ...
    foreach($nrodoctos as $nrodocto){
      $datosempleado = $contratol->ObtenerContratodos($nrodocto);
      ...
      $sbasico = number_format($datosempleado->legcontrato_sbasico, 2, ',', '.');
$html .='
    <tr>
      ...
      <td>'.$datosempleado->imputacion_codigow.'</td>
      <td>'.$fechaingreso.'</td>
      <td>'.$contratofeci.'</td>
      <td>'.$contratofecf.'</td>
      <td>'.$datosempleado->legcontrato_tarea.'</td>
