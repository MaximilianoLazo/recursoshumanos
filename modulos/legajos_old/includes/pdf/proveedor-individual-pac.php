...
if($datossecretario->secretaria_id == 11){
  //texto si desarrollo
  $secac = "A/C de";
  $secacf = "A/C";
}else{
...
<p>
  ...
  <strong><span class="articulo">SEGUNDA:</span>La obligación que contrae</strong> El <strong>contratado</strong> tiene como prioridad inspeccionar obras, como así la realización de notificaciones relacionadas al área de Obras Privadas.-------------<br>
