      ...
      <div class="min-height-200px">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
          ...
          <div class="row">
                  ...
                  <td><?php echo $row->legajo_nrodocto; //$row->doctipo_nombre; ?></td>
                    ...
                    <a href="#"
                       style="color: green;"
                       data-toggle="modal"
                       data-target="#JubiladoNovedad"
                       data-titulo="<?php echo "Jubilado Novedad" ; ?>"
                       data-jubiladoidn="<?php echo $row->cjmdg_personal_nroleg; ?>"
