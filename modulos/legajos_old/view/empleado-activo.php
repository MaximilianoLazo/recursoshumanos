    ...
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
      <div class="min-height-200px">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
          ...
          <div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Listado de Empleados Activos</h5>
						</div>
					</div>
          <div class="row">
							...
							<tbody>
							 ...
							 ?>
								<tr>
									...
									<td><?php	//echo $legajotipo->legtipo_nombre;	?></td>
									<td class="dt-right"><?php //echo $row->legempleado_numerop; ?></td>
									...
									<td>
										...
										<a class="btn btn-outline-warning" href="../marcaciones/?c=marcacion&a=ImprimirFichadaLoteSinFiltroDos&id=<?php echo $row->legempleado_nrodocto; ?>"><i class="icon-copy fi-clock"></i></a>
