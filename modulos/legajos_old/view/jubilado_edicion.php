							...
							<div class="pd-10 bg-white border-radius-4 box-shadow mb-30">
								<div class="clearfix mb-20">
									<div class="pull-left">
										...
										<a href="index.php?c=legajo&a=HaberEditar&id=<?php echo $jub; ?>&seccion=0"  style="color: green;">
											Editar HABER	<i class ='icon-copy ion-android-done-all'></i>
										</a>
									</div>
								</div>
								<div class="row">
