						...
						<div class="col-md-12">
							<div class="form-group">
								<div align="left">
									...
									<button type="button" class="btn btn-success" data-toggle="modal" data-target="#JubiladoAlta" data-titulo="<?php echo 'NUEVO JUBILADO'; ?>">
										NUEVO JUBILADO
									</button>
								</div>
							</div>
								...
								?>
									<tr>
										...
										<td>
											...
											<?php $jubilado_datos = $this->model->JubiladoObtenerEdicionHaber($row->legajo_id);
											$c = count($jubilado_datos);
											if ($c == 1) { ?>
												...
												<?php if (empty($row->situacion_revista_fecingreso)) { ?>
													<a href="#" style="color: green;" data-toggle="modal" data-target="#JubiladoEditarSitRevJub" data-titulo="<?php echo "Tramitar Haber Jubilatorio"; ?>" data-jubiladoidn="<?php echo $row->legajo_id; ?>" data-dni="<?php echo $row->doctipo_nombre . ": " . $row->legajo_nrodocto; ?>" data-nombre="<?php echo $row->legajo_apellido . "," . $row->legajo_nombres; ?>" data-fecha="<?php echo $row->situacion_revista_fecegreso; ?>" data-periodo="<?php echo $per->periodo_id; ?>" data-anio="<?php echo $anio->anio; ?>" data-mes="<?php echo $per->mes; ?>" data-ventana="<?php echo "2"; ?>">
														<i class="icon-copy ion-android-done-all"></i>
														Tramitar Jubilación
													</a>
												<?php } else {	?>
													<a href="#" style="color: green;" data-toggle="modal" data-target="#JubiladoEditarSitRev" data-titulo="<?php echo "Tramitar Haber Jubilatorio"; ?>" data-jubiladoidn="<?php echo $row->legajo_id; ?>" data-dni="<?php echo $row->doctipo_nombre . ": " . $row->legajo_nrodocto; ?>" data-nombre="<?php echo $row->legajo_apellido . "," . $row->legajo_nombres; ?>" data-fecha="<?php echo $row->situacion_revista_fecingreso; ?>" data-periodo="<?php echo $per->periodo_id; ?>" data-anio="<?php echo $anio->anio; ?>" data-mes="<?php echo $per->mes; ?>" data-ventana="<?php echo "1"; ?>">
														<i class="icon-copy ion-android-done-all"></i>
														Tramitar Jubilación
													</a>
											<?php }
