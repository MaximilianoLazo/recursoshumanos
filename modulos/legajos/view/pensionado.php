    ...
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
      <div class="min-height-200px">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
          ...
          <div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Pensionados</h5>
					  </div>
					</div>
          ...
          <div class="row">
                  ...
                  <td><?php echo $row->doctipo_nombre; ?></td>
                    ...
                    <a href="index.php?c=legajo&a=PensionadoEditar&id=<?php echo $row->legajo_id?>&seccion=0"  style="color: green;">
