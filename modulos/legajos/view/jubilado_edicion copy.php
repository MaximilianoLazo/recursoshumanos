			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix">
						...
						<p class="mb-30 font-18">Edicion de Jubilado: <?php echo $jubilado_datos->legajo_apellido .','.$jubilado_datos->legajo_nombres; ?></p>
					</div>
					 	                        ...
					 	                        data-jub="<?php echo $jub; ?>"
					 	                       	...
					 	                       	<i class="icon-copy fi-pencil"></i>
															...
															<button type="button"
																			...
																			data-titulo="<?php echo "ELIMINAR INDIVIDUO"; ?>"
									...
									<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
										...
										<div class="row">
											...
											<td class="dt-right"><?php echo $row->categoria;?></td>
											 <td class="dt-right"><?php echo $row->fecha_inicio;  ?></td>
											 <td class="dt-right"><?php echo $row->fecha_fin;  ?></td>
												<td class="dt-right">
															<button type="button"
																			class="btn btn-primary"
																			data-toggle="modal"
																			data-target="#CategoríaModificar"
																			data-titulo="<?php echo "MODIFICAR CATEGORIA"; ?>"
																			data-pid="<?php echo $row->legapoderado_id; ?>"
																			data-jid="<?php echo $row->legajo_id; ?>"
																			data-tipodni="<?php echo $row->legapoderado_tipo_doc; ?>"
																			data-dni="<?php echo $row->legapoderado_nrodocto; ?>"
								...
								<div class="clearfix mb-20">
									<div class="pull-left">
										...
										<button type="button"
														class="btn btn-success"
														data-toggle="modal"
														data-target="#HaberEditar"
														data-titulo="<?php echo "CALCULAR HABER"; ?>"
														data-pid="<?php echo $jub; ?>"
														data-nom="<?php echo $jubilado_datos->legajo_apellido .','.$jubilado_datos->legajo_nombres; ?>"
														>
													Calcular Haber Jubilatorio
										</button>
										<a href="index.php?c=legajo&a=HaberEdicion&id=<?php echo $jub; ?>&seccion=0"  style="color: green;">
											Editar Cálculo Detallado Haber <i class ='icon-copy ion-android-done-all'></i>
										</a>
									</div>
								</div>
								<div class="row">
									<table class="data-table table-bordered stripe hover nowrap">
										...
										<tr>
											...
											<td class="dt-right"><?php $tot82=$tot120*82/100;echo number_format($tot82);?></td>
											<td class="dt-right">
