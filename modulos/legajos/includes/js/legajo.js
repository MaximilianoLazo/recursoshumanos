...
$('#ImporteModificar').on('show.bs.modal', function(event) {
  ...
  var idhaber2=button.data('idhaber')
  var anio1=button.data('anioo')
  var porant1=button.data('porant')
  ...
  modal.find('.modal-body #hddhaber1').val(idhaber2)
  modal.find('.modal-body #hddporant').val(porant1)
  modal.find('.modal-body #hddanio').val(anio1)
  modal.find('.modal-body #hddcat').val(cat1)
  //modal.find('.modal-body #hdddni').val(dni)
