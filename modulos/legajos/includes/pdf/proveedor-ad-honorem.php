...
$dependencia = mb_strtoupper($datoscontrato->impdependencia_nombre);
...
$html = '
<div class="tituloc"><u class="titulo"><strong>CONTRATO DE TRABAJO AD-HONOREM</strong></u></div>
<p>
  ...
  <strong><span class="articulo">PRIMERA:</span></strong> El <strong>contratante</strong> ofrece los servicios ante la <strong>'.$datoscontrato->secretaria_nombre.', '.$datoscontrato->trabajo_nombre.', '.$datoscontrato->legproveedor_tarea.'</strong>, quedando obligado a cumplir sus servicios en el horario, tiempo, lugar y forma que el contratante lo determine; siéndole compatible desempeñar cualquier actividad privada, fuera del horario asignado y/o de los requerimientos de la Municipalidad.---------<br>
  <strong><span class="articulo">SEGUNDA:</span></strong> El <strong>contratado</strong> desempeñará funciones AD-HONOREM.-------<br>
  <strong><span class="articulo">TERCERA:</span></strong> La vigencia del presente contrato será desde el día <strong>'.$contratofechai.'</strong> hasta el <strong>'.$contratofechaf.'</strong> inclusive.------------------------------------------<br>
  <strong><span class="articulo">CUARTA: </span></strong>Las partes se reservan el derecho de rescindir el presente contrato en cualquier oportunidad, debiendo comunicar dicha decisión a la otra parte por escrito, operando la resolución contractual a partir del día de la notificación. En caso de resolverse la contratación aún sin causa por parte del Ente Municipal antes del plazo fijado en el contrato, ello no generará derecho a retribución ni indemnización alguna a favor del contratado, que renuncia a formular cualquier tipo de reclamación por concepto alguno.------------------------------------------------------<br>
  <strong><span class="articulo">QUINTA: </span></strong>Vencida la fecha, este contrato caducará en forma automática, debiendo las partes en este último supuesto firmar un nuevo contrato que regule la relación administrativa de prestación de servicios. Así de conformidad, las partes previa lectura y ratificación de lo expuesto, firman el presente en tres (03) ejemplares de un mismo tenor y a un solo efecto, en la ciudad de Gualeguay, Provincia de Entre Ríos a '.$fechaimpresion.'.----------------------<br><br><br>
  <table width="100%">
    <tr>
      <td height="10px"></td>
