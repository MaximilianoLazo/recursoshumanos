<form id="#" action="?c=empleado&a=PreNatalEliminar" method="post" enctype="multipart/form-data">
  <div class="modal fade" id="dataDeletePreNatal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <input type="hidden" id="prenatalid" name="prenatalid">
