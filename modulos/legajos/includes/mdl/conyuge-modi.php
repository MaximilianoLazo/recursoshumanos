<form id="" action="?c=legajo&a=ConyugeModificar" method="post" enctype="multipart/form-data">
    <div class="modal fade" id="ConyugeModificar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <input type="hidden" class="form-control" id="hddconyugeidn" name="hddconyugeidn" >
        <input type="hidden" class="form-control" id="hddjubiladoidn" name="hddjubiladoidn" >
        <div class="row">
            <div class="col-xs-12 col-sm-6">
              <div class="form-group">
                  <input type="text" class="form-control" id="hddapellido" name="hddapellido" >
              </div>
            </div>
            <div class="col-xs-12 col-sm-6">
              <div class="form-group">
