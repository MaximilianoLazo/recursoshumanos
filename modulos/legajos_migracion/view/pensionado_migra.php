      ...
      <div class="min-height-200px">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
          ...
          <div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Listado de Pensionados</h5>
					  </div>
    			</div>
          ...
          <div class="row" >
						<table class="data-table table-bordered stripe hover nowrap">
							...
							<tbody>
							 <?php
							 	foreach($this->model->ListarPensionados() as $row):
								...
								<tr>
									...
									<td>
										<a href="index.php?c=legajo&a=PensionadoEditarPer&id=<?php echo $row->legajo_id;?>&seccion=0" style="color: green;">
