    ...
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
      <div class="min-height-200px">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
          ...
          <div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Listado de Jubilados</h5>
					  	</div>
			</div>
          ...
          <div class="row" >
						<table class="data-table table-bordered stripe hover nowrap">
							...
							<tbody>
							 <?php
							 	foreach($this->model->ListarJubiladosActivos() as $row):
								...
								<tr>
										...
										<td><?php echo $row->cjmdg_personal_nroleg2;	?></td>
									
										<td><?php echo $row->legajo_cuil; ?></td>
										<td><?php echo $row->legajo_fecnacto; ?></td>
										<td><?php echo $row->legajo_fecing;?></td>
										<td><?php if($row->legajo_fecegr!="0000-00-00"){echo date("d/m/Y",strtotime($row->legajo_fecegr));}else{echo "  ";}?></td>
									<td>
									<?php if($row->legajo_fecegr=="0000-00-00"){ ?>
										<a href="index.php?c=legajo&a=JubiladoEditarPer&id=<?php echo $row->legajo_id;?>&seccion=0" style="color: green;">
										Editar	<i class ='icon-copy ion-android-done-all'></i>
										</a>
									<?php } ?>
									</td>
								</tr>
