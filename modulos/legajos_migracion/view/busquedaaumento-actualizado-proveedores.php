						...
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Inicio</h4>
									...
									||||||||||||||||||||||||
									+6+
															¿'|1c xz<_   1+0-/'<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
...
+							<div class="dropdown">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Listado de Contratos (Proveedores) Actualizados</h5>
						</div>
					</div>
					<?php
								...
								<tbody>
									<?php
										foreach($nrodoctos as $nrodocto):
											$contratodatos = $this->model->ObtenerContratosProveedoresactualizados($nrodocto);
											$contratofecingresodmy = date("d/m/Y", strtotime($contratodatos->legempleado_fecingreso));
											$contratofeciniciodmy = date("d/m/Y", strtotime($contratodatos->legproveedor_fecinicio));
											$contratofecfindmy = date("d/m/Y", strtotime($contratodatos->legproveedor_fecfin));

											$sbasiconuevo = number_format($contratodatos->legproveedor_sbasico, 2, ',', '.');
									?>
									<tr>
										...
										<td data-title="Tarea:"><?php echo $contratodatos->legproveedor_tarea; ?></td>
										...
										<td data-title="Acciones:">
											<button type="button"
															...
															data-imputacion="<?php echo $contratodatos->imputacion_id."-".$contratodatos->impactividad_id; ?>"
