...
class EmpleadoController{
    ...
    public function GuardarEmpleado(){
        ...
        $empleado1->Empdisc = $_REQUEST['jubdisc'];
        $empleado1->Emptleg = 0;
    ...
    public function GuardarEmpleadoDomicilio(){
        ...
        header("Location: index.php?c=legajo&a=Crud&id=$empleado2->Empid&startIndex=0");
    ...
    public function BajaEmpleado(){
        ...
        $empleado4->Fechaegreso = $_REQUEST['txtempfecbajae'];
