<form id="" action="?c=legajo&a=JubiladoEditarSitRevJub" method="post" enctype="multipart/form-data">
    <div class="modal fade" id="JubiladoEditarSitRevJub" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h2 class="display-4">TRAMITAR JUBILACION?</h2>
        ...
        <div class="col-md-6">
											<div class="form-group">
												...
												<input type="checkbox" name="hijodisc" id="hijodisc" value="" class="custom-control-input" disabled>
											</div>
    									</div>
