...
<p>
  ...
  <strong><span class="articulo">PRIMERA:</span></strong> El <strong>contratante</strong> requiere los servicios del contratado para desempeñarse en la <strong>'.$datoscontrato->secretaria_nombre.', '.$datoscontrato->trabajo_nombre.', </strong>desempeñando tareas como,<strong> '.$datoscontrato->legproveedor_tarea.'</strong>.--------------<br>
  <strong><span class="articulo">SEGUNDA:</span></strong> La obligación que contrae El <strong>contratado</strong> tiene como prioridad realizar funciones como Asesor, Analista y Programador en la aplicacion <strong>"MI GUALEGUAY"</strong> Los resultados del trabajo en equipo, CONTRATISTA y CONTRADO constituyen obras colectivas anónimas cuyos derechos de autor corresponden en forma exclusiva al CONTRATISTA en los términos de los articulos 8 y 16 de la ley 11.723.<br>
  El resultado de todos y cada uno de los esfuerzos intelectuales que el CONTRATADO desarrolle en cumplimiento de sus obligaciones laborales pasar automáticamente a constituir propiedad intelectual del contratista y se entenderá retribuido con el salario que este paga al contratado.<br>
  El contratado se compromete asimismo a no utilizar dicho trabajo intelectual desarrollado en cumplimiento de sus obligaciones laborales en su propio beneficio, ni tampoco en beneficio de cualquier otra personal que no sea el contratista.<br>
  Las obligaciones derivadas del presente se mantendrán vigentes sin limitaciones en el tiempo, aum luego de finalizada la relación laboral entre el contratado y contratista.<br>
  El contratado se desempeñara en la <strong>'.$datoscontrato->secretaria_nombre.'</strong>, quedando obligado a cumplir sus servicios en el horario, tiempo, lugar y forma que el contratante lo determine; siéndole compatible desempeñar cualquier actividad privada, fuera del horario asignado y/o de los requerimientos de la Municipalidad.---------<br>
