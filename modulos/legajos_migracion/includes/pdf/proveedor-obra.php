...
if($datossecretario->secretaria_id == 15){
  //texto si desarrollo
  $secac = "A/C de";
  $secacf = "A/C";
}else{
...
<p>
  ...
  <strong><span class="articulo">PRIMERA:</span></strong> El <strong>contratante</strong> requiere los servicios del contratado para desempeñarse en la <strong>'.$datoscontrato->secretaria_nombre.', desempeñado tareas como, '.$datoscontrato->legproveedor_tarea.'</strong> en el marco de la <strong>Ordenanza 2847/17 y 2912/18</strong>.--------------<br>
  <strong><span class="articulo">SEGUNDA:</span>La obligación que contrae</strong> El <strong>contratado</strong> tiene como prioridad el control de documentación Técnica de Estructuras Soporte de Sistema de Comunicaciones e Infraestructuras Asociadas, solicitud de Habilitación de las mismas y localización de estructuras ya existentes para su respectiva habilitación.-------------<br>
  ...
  <strong><span class="articulo">CUARTA:</span></strong> Por los servicios correspondientes la <strong>contratante</strong> abonará a <strong>el contratado</strong> como contraprestación una remuneración equivalente al 20% que será calculado en base al valor de la tasa percibido por cada estructura habilitada por el Municipio local, en concepto de Solicitudes de habilitación de Estructura Soporte de Sistemas de Computaciones e Infraestructuras Asociadas, ART. 31) Ordenanza N° 2847/17, con los alcances establecidos mediante Ordenanza 2912/18, dicho porcentaje será informado de manera mensual por parte la autoridad de aplicación.-------<br>
