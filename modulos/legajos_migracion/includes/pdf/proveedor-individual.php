...
<p>
  ...
  <strong><span class="articulo">CUARTA:</span></strong> Por los servicios correspondientes la <strong>contratante</strong> abonará a <strong>el contratado</strong> como contraprestación una suma de Pesos <strong>$ '.$sbasiconum.' ('.$sbasicoletra.')</strong>, mensuales, por una carga horaria equivalente a 10 hs. Los casos de menor carga horaria se abonaria de manera proporcional, otorgado este último la correspondiente Factura o Recibo.-------<br>
