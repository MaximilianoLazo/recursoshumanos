...
class Empleado{
	...
	public function ObtenerProveedor($nrodocto){
		try{
			$sql = 'SELECT * FROM legajos_proveedor a, legajos b, secretarias c, lugares_trabajo d, contratos_modelos e WHERE a.contrato_modelo_id = e.contrato_modelo_id AND a.legajo_id = b.legajo_id AND a.secretaria_id = c.secretaria_id AND a.trabajo_id = d.trabajo_id AND a.legajo_id = ? AND a.legproveedor_activo = 1 LIMIT 1';
			$dec = $this->cn->prepare($sql);
			$dec->bindValue(1, $nrodocto, PDO::PARAM_STR);
			$dec->execute();
			return $dec->fetch(PDO::FETCH_OBJ);
	...
	public function ObtenerContratodos($nrodocto){
		try{
			...
			$sql = 'SELECT a.legcontrato_id,a.legcontrato_fecinicio,a.legcontrato_fecfin,a.legcontrato_tarea,a.legcontrato_sbasico,b.legempleado_nrodocto,b.legempleado_nrocuil,b.legempleado_apellido,b.legempleado_nombres,b.sexo_id,b.legempleado_direccion,b.legempleado_direcnro,b.legempleado_fecingreso,c.secretaria_id,c.secretaria_nombre,d.imputacion_codigow,d.imputacion_id,d.imputacion_nombre,f.trabajo_id,f.trabajo_nombre FROM legajos_contrato a, legajos_empleado b, secretarias c, imputaciones d, lugares_trabajo f WHERE a.legempleado_nrodocto = b.legempleado_nrodocto AND a.secretaria_id = c.secretaria_id AND a.imputacion_id = d.imputacion_id AND a.trabajo_id = f.trabajo_id AND a.legempleado_nrodocto = ? AND a.legcontrato_activo = 1';
			$dec = $this->cn->prepare($sql);
			$dec->bindValue(1, $nrodocto, PDO::PARAM_STR);
			$dec->execute();
	...
	public function ListarEmpleados(){
		try{
		$sql = $this->cn->prepare("SELECT * FROM legajos a, sexos b, estados_civiles c WHERE a.sexo_id=b.sexo_id AND a.estado_civil_id=c.estcivil_id AND a.legajo_estado_id='1'");
		$sql->execute();
	...
	public function ObtenerTipoLegajo($nrodocto){
		try{
			...
			$sql = 'SELECT b.legajo_tipo_nombre FROM legajos a, legajos_tipos b WHERE a.legajo_tipo_id = b.legajo_tipo_id AND a.legajo_nrodocto = ? LIMIT 1';
			$stm = $this->cn->prepare($sql);
		...
		try{
			...
			if($lugardetrabajo == "T"){
				...
				$sql = 'SELECT * FROM legajos_contrato a,
															legajos b,
															lugares_trabajo c
												 WHERE a.legajo_nrodocto = b.legempleado_nrodocto
												 AND a.trabajo_id = c.trabajo_id
												 AND a.secretaria_id = ?
												 AND b.legajo_tipo_id = 1
												 AND b.legajo_estado_id = 1
												 AND a.legajo_contrato_activo = 1
												 AND a.legajo_contrato_sbasico
											   BETWEEN ? AND ?
	...
	public function ListarContratosSinRenovar($secretaria, $tipodecontrato, $ordenci){
		try{
			...
			if($ordenci == 1){
				...
				$sql = 'SELECT *,a.secretaria_id FROM legajos_contrato a, legajos_empleado b, lugares_trabajo c WHERE a.legempleado_nrodocto = b.legempleado_nrodocto AND a.trabajo_id = c.trabajo_id AND a.secretaria_id = ? AND a.legcontrato_fecfin < ? AND b.legempleado_activo = 1 AND a.legcontrato_activo = 1 ORDER BY '.$ordencontrato.'';
				$stm = $this->cn->prepare($sql);
				$stm->bindValue(1, $secretaria, PDO::PARAM_STR);
	...
	public function ObtenerPteMuniciapal(){
		try{
			$secretaria = 1;
			$sql = 'SELECT a.secretaria_id,a.secretaria_profesion,b.legempleado_apellido,b.legempleado_nombres,b.sexo_id,b.legempleado_firma FROM secretarias a, legajos_empleado b WHERE a.legempleado_id=b.legempleado_id AND a.secretaria_id = ?';
			$stm = $this->cn->prepare($sql);
			$stm->bindValue(1, $secretaria, PDO::PARAM_STR);
			$stm->execute();
	...
	public function ObtenerSecretario($secretariaid){
		try{
			...
			$sql = 'SELECT a.secretaria_id,a.secretaria_nombre,a.secretaria_nombrec,a.secretaria_profesion,b.legempleado_apellido,b.legempleado_nombres,b.sexo_id,b.legempleado_firma FROM secretarias a, legajos_empleado b WHERE a.legempleado_id=b.legempleado_id AND a.secretaria_id = ?';
			$stm = $this->cn->prepare($sql);
			$stm->bindValue(1, $secretariaid, PDO::PARAM_STR);
			$stm->execute();
	...
	*/
	...
	public function ObtenerContratoTipo($empdocto){
		try{
			$sql = 'SELECT 	b.legtipo_nombre FROM legajos_empleado a, legajos_tipo b WHERE a.legtipo_id = b.legtipo_id AND a.legempleado_nrodocto = ? ORDER BY a.legtipo_id DESC LIMIT 1';
			$stm = $this->cn->prepare($sql);
	...
	public function RegistrarContrato($data){
		try{
			...
			$sql = 'UPDATE legajos_empleado SET legtipo_id = ? WHERE legempleado_nrodocto = ?';
	...
	public function GuardarProveedorExe($data){
		try{
			...
			$sql = 'UPDATE legajos_empleado SET legtipo_id = 4 WHERE legempleado_nrodocto = ?';
	...
	public function GuardarEmpleadoExe($data){
		try{
			//--------- Insert de empleados -------------
			$sql = 'INSERT INTO legajos_empleado (legempleado_numerop,
			...
			$sql = 'SELECT * FROM legajos_empleado WHERE legempleado_id = ? LIMIT 1';
			$stm = $this->cn->prepare($sql);
			$stm->bindValue(1, $ultimoid, PDO::PARAM_STR);
			$stm->execute();
			$row = $stm->fetch(PDO::FETCH_OBJ);
	...
	public function ActualizarEmpleadoExe($data){
		try{
			...
			/*$sql = 'UPDATE legajos_empleado SET legempleado_numerop = ?,
																					legempleado_nrodocto = ?,
																					legempleado_nrocuil = ?,
																					legempleado_apellido = ?,
																					legempleado_nombres = ?,
	...
	public function ActualizarEmpleadoDomicilioExe($data){
		try{
			...
			$sql = 'UPDATE legajos_empleado SET legempleado_direccion = ?,
																					legempleado_direcnro = ?,
																					legempleado_direcpiso = ?,
																					pais_id = ?,
																					provincia_id = ?,
	...
	public function ActualizarEmpleadoContactoExe($data){
		try{
			...
			$sql = 'UPDATE legajos_empleado SET legempleado_celular = ?,
																					legempleado_telefono = ?,
																					legempleado_email = ?
																		WHERE legempleado_nrodocto = ?';
	...
	public function BajaEmpleadoExe($data){
		try{
			...
			$sql = 'UPDATE legajos SET legajo_fecegr = ?,																				
									   legajo_activo = 0
