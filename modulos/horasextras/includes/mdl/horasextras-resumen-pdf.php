...
<div class="modal fade" id="dataViewHorasExtrasResumenPDF" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12">
            <div class="form-group">
              ...
              <select name="cbolugardetrabajopdf" id="cbolugardetrabajopdf" class="custom-select form-control" disabled>
        ...
        <div class="row">
          <div class="col-xs-4 col-sm-6">
            <div class="form-group">
              ...
              <select name="cbotipodelegajopdf" id="cbotipodelegajopdf" class="custom-select form-control" disabled>
                <option value="T">Todos --></option>
          ...
          <div class="col-xs-4 col-sm-6">
            <div class="form-group">
              ...
              <select name="cboordenhorasexpdf" id="cboordenhorasexpdf" class="custom-select form-control" disabled>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" id="btnhorasextrasresumenimplistado">DESCARGAR PDF</button>
        <!--
