...
class ImputacionController{
    ...
    public function GuardarI(){
        ...
        $imputacion->ImputacionCodigo = $_REQUEST['imputacioncodigo'];
        $imputacion->ImputacionNombre = $_REQUEST['imputacionnombre'];
        $imputacion->ImputacionImporteAu = $_REQUEST['imputacionimporteau'];
        $imputacion->ImputacionCantidadAu = $_REQUEST['imputacioncantidadau'];
