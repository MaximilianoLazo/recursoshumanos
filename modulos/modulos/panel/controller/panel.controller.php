...
class PanelController{
    ...
    public function Index(){
      //---- Cofiguracion de Periodo----
      /*
      date_default_timezone_set("America/Buenos_Aires");
      $fecha_actual = date("Y-m-d");
      $hora_actual = date("H:i:s");
      $periodoactual = $this->model->PeriodoActual();
      $periodoactualfinal = $periodoactual->periodo_hsext_jor_f;
      if($fecha_actual > $periodoactualfinal){
        //---- periodo actual vencido ---
        $this->model->PeriodoAlta($periodoactualfinal);
