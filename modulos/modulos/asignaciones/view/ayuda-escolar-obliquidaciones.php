	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
          ...
          <div class="row">
                ...
                //$periodoid = 42;
                $ayudaescolarobliq = $this->model->AyudaEscolarOBLiqListado($periodoid);
                $ayudaescolarobliqc = count($ayudaescolarobliq);
                if($ayudaescolarobliqc > 0){
                  ?>
                  <!--<div align="right">
                    ...
                    <a  class="btn btn-info" href="?c=asignacion&a=CalcularImportesOB">CALCULAR Importes - No valido</a>
  								</div>-->
                ...
                ?>
                <div align="right">
                  <a  class="btn btn-info" href="?c=asignacion&a=LiquidarAyudaEscolarOB">LIQUIDAR Ayuda Escolar OB</a>
                </div>
                <div align="right">
                  <a  class="btn btn-danger" href="?c=asignacion&a=AyudaEscolarOBExportarPDF">PDF</a>
                </div>
                <div align="right">
                  <a  class="btn btn-success" href="?c=asignacion&a=AyudaEscolarOBExportarCSV">Excel</a>
                </div>
							</div>
						</div>
					</div>
                  ...
                  <th style="color:#000000;font-size:10px;">Total</th>
							...
							<tbody>
							 <?php
                foreach($ayudaescolarobliq as $row):
