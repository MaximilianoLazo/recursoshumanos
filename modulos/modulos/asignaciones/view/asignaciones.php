		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
          ...
          <div class="row">
                ...
                $fecha_final = date("Y-m-d",strtotime($fecha_actual."- 6 year"));//resto 5 años
				        //$fecha_final = date("Y-m-d",strtotime($fecha_uno."- 7 month"));//resto 5 meses
                      ...
                      <table width="100%" class="table table-striped table-hover table-fixed">
                        <thead>
                          <tr>
                            ...
                            <td style="background: #FFFFFF; font-size: 12px;">APELLIDO Y NOMBRES</td>
                            <td style="background: #FFFFFF; font-size: 12px;">FECHA</td>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                          ...
                          <tr>
                            ...
                            <td style="font-size: 12px;" data-title="H Menor">
                              <?php echo $hijodatos->leghijo_apellido.", ".$hijodatos->leghijo_nombres; ?>
                            </td>
                            <td style="font-size: 12px;" data-title="Prescolar">
