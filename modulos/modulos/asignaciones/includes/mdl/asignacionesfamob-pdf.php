...
<div class="modal fade" id="dataViewAsignacionesFamOBPDF" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" id="btnasignacionesfamobimplistado">DESCARGAR PDF</button>
