...
<body>
	...
	<!--**********ventanas modal***********-->
	<?php include("includes/modal/contratoactualizacion.php");?>
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<?php
						...
						$dependenciasapp = $this->model->ObtenerDependencias($imputacionid);
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<div align="right">
									<!--
									<button type="button" class="btn btn-danger" id="BtnImprimirContratosC">Volver a Imputaciones</button>
								-->
									<a  class="btn btn-danger" href="?c=dependencia&a=ListadoImputacion&id=<?php echo $imputacionid; ?>">Volver a Imputaciones</a>
		      ...
		      <div id="no-more-tables">
		        <div class="table-wrapper-scroll-y my-custom-scrollbar">
		          <table border="1" class="table table-striped table-hover table-fixed">
								...
								<tbody>
									<?php
										foreach($this->model->ObtenerListadoImputaciondos($imputacionid) as $row):
											$datotrabajo = $this->model->ObtenerLTrabajo($row->trabajo_id);
											$datodependencia = $this->model->ObtenerDepEmpleado($row->legcontrato_id);
											$depnombre = $datodependencia->impdependencia_nombre;
									...
									<tr>
										...
										<td data-title="no name:">
											<?php
												//echo $datodependencia->impdependencia_nombre;
												if(empty($depnombre)){
    											?>
													<div class="pull-left"><h5 class="text-danger">Dependencia no aplicada</h5></div>
													<?php
												}else{

													?>
													<div class="pull-left"><h5 class="text-success"><?php echo $depnombre; ?></h5></div>
													<?php
												}
											?>
										</td>
