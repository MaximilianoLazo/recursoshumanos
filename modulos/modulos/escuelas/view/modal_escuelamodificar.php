...
<div class="modal fade bd-example-modal-lg" id="dataUpdateEscuela" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-7">
            <div class="form-group">
              ...
              <input type="text" name="escuelanombre" id="escuelanombre" class="form-control form-control-sm" placeholder="Ej: Celestino Irineo Marcó" required>
            </div>
          </div>
