...
<body>
			...
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Entrega de Ordenes de Indumentaria</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item active"><a href="index.php">Inicio</a></li>
									<li class="breadcrumb-item" aria-current="page">Entrega de Ordenes de Indumentaria</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Entregar Orden</h5>
						</div>
					</div>
					<?php
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label for="txtindumentarianrodocto">DNI de Empleado o Nro de Orden :</label>
								<input type="text" name="txtindumentarianrodocto" id="txtindumentarianrodocto" value="<?php echo $valorimput; ?>" class="form-control" required>
							</div>
						</div>
				...
				<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<button type="button" class="btn btn-primary" id="btnentregaorden">Buscar</button>
							</div>
						</div>
				</div>
  ...
  <script>
		jQuery(document).ready(function(){
			...
			jQuery("#btnentregaorden").click(function(){
				//cogemos el valor del input
				var nrodocto = jQuery("#txtindumentarianrodocto").val();
				var params = {
					"NroDocto" : nrodocto,
				};
				...
				$.ajax({
					data:  params,
          url:   '?c=indumentaria&a=IndumentariaOrdenRespuesta',
					dataType: 'html',
					type:  'post',
					beforeSend: function () {
