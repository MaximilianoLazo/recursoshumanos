...
foreach($datosexportob as $value){
        ...
        $importeob = $exportob->ObtenerImporteOB($empleado,$beneficiario);
		$importeobdos = $importeob->importeob;
		$importeobtres = number_format($importeobdos, 2, ',', '.');

        $lineData = array('mar-19', '310319', '0', '0', '0', '5000002000   ASIG.FAM', $ccosto->haberrem_centrocosto, '', 'D', $importeobtres);
