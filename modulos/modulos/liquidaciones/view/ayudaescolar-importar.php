...
<body>
	...
	<!--**********ventanas modal***********-->
	<?php include("includes/mdl/ayudaescolar-importar.php");?>
							...
							<div class="form-group">
								...
								-->
									<button type="button"
													...
													data-toggle="modal"
													data-target="#AyudaEscolarImportar"
													data-titulo="<?php echo "Importar Listado de Ayuda Escolar"; ?>">
													IMPORTAR Ayuda Escolar
									</button>
								</div>
							</div>
						</div>
