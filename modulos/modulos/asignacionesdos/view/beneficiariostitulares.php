            ...
            -->
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Beneficiarios Titulares</h5>
						</div>
					</div>
          <div class="row">
						<div class="col-md-12">
                ...
                ?>
                  ...
                  <th style="color:#000000;font-size:13px;">Situación de Revista</th>
               ...
               ?>
                  ...
                  <td style="color:#000000;font-size:13px;"><?php echo $datoslegajotipo->legtipo_nombre; ?></td>
