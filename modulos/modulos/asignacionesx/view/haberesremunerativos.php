		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
          ...
          <div class="row">
						<div class="col-md-12">
							<div class="form-group">
                <div align="right">
                  <a  class="btn btn-info" href="?c=asignacion&a=AsignacionesOBLiquidaciones">Ir a ASIGNACIONES (Otros Beneficiarios)</a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <th>Haber Remun.</th>
							...
							<tbody>
							 <?php foreach($this->model->HaberesRemunerativos() as $row): ?>
								<tr>
                  <td><?php echo $row->legempleado_numero; ?></td>
                  <td><?php echo $row->legempleado_nrodocto; ?></td>
									<td><?php echo $row->haberrem_centrocosto; ?></td>
                  <td><?php echo $row->haberrem_importe; ?></td>
								</tr>
							<?php endforeach; ?>
							</tbody>
						</table>
