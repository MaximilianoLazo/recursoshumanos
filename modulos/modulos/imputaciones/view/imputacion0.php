	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
          ...
          <!-- Data tables Imputaciones -->
                  ...
                  ?>
                  <td><?php echo $row->imputacion_codigow; ?></td>
                  <td><?php echo $row->imputacion_nombre; ?></td>
                  <td><?php echo $row->imputacion_cupos; ?></td>
                  <td><?php echo $empleadosc->imputacionc; ?></td>
                  <td><?php echo $cuposdisponibles; ?></td>
									<td>
										<!-- Boton editar -->
                    ...
                    <!-- Boton Listado Modal -->
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#dataTableViewImputacion" data-titulo="Edicion de Imputacion" data-id="<?php echo $row->imputacion_id; ?>" data-impcodigow="<?php echo $row->imputacion_codigow; ?>" data-impcodigos="<?php echo $row->imputacion_codigos; ?>" data-impnombre="<?php echo $row->imputacion_nombre; ?>" id="<?php echo $row->imputacion_codigow; ?>"><i class="icon-copy fa fa-list" aria-hidden="true"></i></button>
          ...
          <br>
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Imputaciones por Secretarias</h5>
						</div>
					</div>

					<div class="row">
						<table class="data-table-sec table-bordered stripe hover nowrap">
							<thead>
								<tr>
                  <th>Secretaria</th>
                  <th>Utilizados</th>
                  <th>Acciones</th>
							...
							<tbody>
							 <?php foreach($this->model->ListarSecretarias() as $row): ?>
								<tr>
                  <?php
                    $secretariaid = $row->secretaria_id;
                    $empleadossc = $this->model->ImputacionesXSecretaria($secretariaid);
                  ?>
                  <td><?php echo $row->secretaria_nombre; ?></td>
                  <td><?php echo $empleadossc->imputacionsc; ?></td>
