			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Lugares de Trabajo</h5>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
                  ...
                  <td>20</td>
									<td>
										...
										<!-- Boton editar -->
										<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#dataUpdateLugarDeTrabajo" data-titulo="<?php echo "Editar Lugar de Trabajo"; ?>" data-id="<?php echo $row->trabajo_id; ?>" data-trabajonombre="<?php echo $row->trabajo_nombre; ?>" data-trabajosec="<?php echo $row->secretaria_id; ?>"><i class="icon-copy fi-pencil" aria-hidden="true"></i></button>
										<!-- Boton deshabilitar -->
										<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#dataDeleteLugarDeTrabajo" data-id="<?php echo $row->trabajo_id; ?>"><i class="icon-copy fa fa-trash" aria-hidden="true"></i></button>
									</td>
								</tr>
							<?php endforeach; ?>
							</tbody>
