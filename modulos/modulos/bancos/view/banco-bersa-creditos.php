							...
							<tbody>
							 ...
							 ?>
								<tr>
									...
									<td class="dt-right"><?php echo $row->legempleado_cuil; ?></td>
									<td><?php echo $empleadodatos->legempleado_apellido.", ".$empleadodatos->legempleado_nombres; ?></td>
									<td class="dt-right" data-order="<?php echo $row->bco_credito_importe; ?>" >
				              <?php echo "$ ".$bcocreditoimporte_format; ?>
				          </td>
									<td class="dt-right"><?php echo $row->bco_credito_cuotas; ?></td>
									<td>
										<!--
										<button type="button"
														class="btn btn-danger"
