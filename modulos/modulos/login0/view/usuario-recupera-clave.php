...
error_reporting ( E_ALL );
	...
	if(!empty($_POST)){
		...
		if($this->model->emailExiste($email)){
			...
			$url = 'http://'.$_SERVER["SERVER_NAME"].'/controlhorarioxx/modulos/login/?c=login&a=UsuarioCambiaClave&id='.$user_id.'&token='.$token;

			$asunto = 'Activar Cuenta - Sistema de Recursos Humanos';
