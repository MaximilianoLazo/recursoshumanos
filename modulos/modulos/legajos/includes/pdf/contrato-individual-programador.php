...
if($datossecretario->secretaria_id == 7){
  //texto si desarrollo
  $secac = "A/C de";
  $secacf = "A/C";
}else{
...
<p>
  ...
  <strong><span class="articulo">PRIMERA:</span></strong> El <strong>contratante</strong> requiere los servicios del contratado como Asesor, Analista y Programador para realizar tareas de análisis y programación.<br>
  Los resultados del trabajo en equipo, CONTRATISTA y CONTRADO constituyen obras colectivas anónimas cuyos derechos de autor corresponden en forma exclusiva al CONTRATISTA en los términos de los articulos 8 y 16 de la ley 11..723.<br>
