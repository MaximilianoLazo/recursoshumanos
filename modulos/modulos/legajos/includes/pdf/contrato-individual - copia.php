...
<p>
  ...
  <table width="100%">
    ...
    <tr>
      ...
      <td style="font-size:7.5pt"><center>'.$secretariocargom.' DE '.$secrtariacm.'</center></td>
    </tr>
    <tr>
      <td></td>
      <td></td>
...
//$mpdf->PDFA = true;
//$mpdf->PDFAauto = true;
$css = file_get_contents('ordenalta.css');
