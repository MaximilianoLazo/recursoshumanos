			...
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Empleados (Inactivos)</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Empleados Inactivos</h5>
						</div>
					</div>
					<div class="row">
						<table class="data-table table-bordered stripe hover nowrap">
							...
							<tbody>
							 <?php foreach($this->model->ListarEmpInactivos() as $row): ?>
								<tr>
									<!--
									<td class="table-plus">
										<?php
									...
									<td><?php echo $row->legempleado_fecbaja; ?></td>
									<td>
										<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#dataDelete" data-id=""><i class="ion-arrow-swap"></i> Reincorporar </button>
										<button type="button" class="btn btn-success" data-toggle="modal" data-target="#dataDelete" data-id=""><i class="fa fa-th-list" aria-hidden="true"></i> Detalles</button>
									</td>
								</tr>
							<?php endforeach; ?>
							</tbody>
