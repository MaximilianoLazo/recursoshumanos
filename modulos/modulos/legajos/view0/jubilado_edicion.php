                ...
                <div class="row">
                 ...
                 <br>
                  <br>
												...
												<tbody>
												 ...
												 ?>
													<tr>
														...
														<a class ="btn btn-primary" href="index.php?c=legajo&a=IndividuoABM&id=<?php echo $fam->legajo_id?>&startIndex=0">
																	<i class ='icon-copy fi-pencil'></i>
														</a>
															...
															<button type="button"
																			class="btn btn-primary"
																			data-toggle="modal"
																			data-target="#IndividuoEditar"
																			data-titulo="<?php echo "Modificar individuo"; ?>"
																			data-pid="<?php //echo $fam->legajo_id; ?>"
																			data-idnitip="<?php //echo $fam->tipodocto_id; ?>"
																			data-idninro="<?php //echo $fam->individuo_nrodocto; ?>"
																			data-iape="<?php //echo $fam->individuo_apellido; ?>"
																			data-inom="<?php //echo $fam->individuo_nombres; ?>"
																			data-ifnac="<?php //echo $fam->individuo_fecnacto; ?>"
																			data-isex="<?php //echo $fam->sexo_id; ?>"
																			data-ieciv="<?php //echo $fam->estcivil_id; ?>"
																			data-icel="<?php //echo $fam->individuo_celular; ?>"
																			data-iobsoc="<?php //echo $fam->obra_social_id; ?>"
																			>
																			-->
															<button type="button"
																			class="btn btn-danger"
													...
													<tr>
														...
														<td class="dt-right">
															...
															<button type="button"
																			...
																			data-nom="<?php echo $row->legapoderado_apellido; ?>"
																			data-ape="<?php echo $row->legapoderado_nombres; ?>"
																			data-dir="<?php echo $row->legapoderado_direccion; ?>"
																			data-celu="<?php echo $row->legapoderado_celular; ?>"
																			>
																			<i class='icon-copy fi-pencil'></i>
															</button>
						...
						<h5>Haber Jubilatorio2</h5>
						<section>

							<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
								<div class="clearfix mb-20">
									<div class="pull-left">
										<h5 class="text-blue">Prorrateo para cálculo del Haber Jubilatorio <?php echo $row->legapoderado_apellido.", ".$row->legapoderado_nombres; ?></h5>
									</div>
								</div>
								<div class="row">
									<table class="data-table table-bordered stripe hover nowrap">
										...
										<tbody>
										 <?php
										 	$jub_haber = $this->model->JubiladoObtenerHaber($jub);
											foreach($jub_haber as $row):
										 ?>
											<tr>
												<td class="dt-right"><?php echo $row->legapoderado_nrodocto;?></td>
												<td></td>
												...
												<td class="dt-right">
													<button type="button"
																	...
																	data-titulo="<?php echo "MODIFICAR APODERADO"; ?>"
																	data-pid="<?php echo $row->legapoderado_id; ?>"
																	data-jub="<?php echo $row->legajo_id; ?>"
																	data-dni="<?php echo $row->legapoderado_nrodocto; ?>"
																	data-nom="<?php echo $row->legapoderado_apellido; ?>"
																	data-ape="<?php echo $row->legapoderado_nombres; ?>"
																	data-dir="<?php echo $row->legapoderado_direccion; ?>"
