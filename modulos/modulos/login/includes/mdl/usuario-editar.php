        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-xs-6 col-sm-6">
              <div class="form-group">
                ...
                <input type="text" name="txtempfecbajae" id="txtempfecbajae" value="<?php echo $fecha_actual; ?>" class="form-control form-control-sm" required />
              </div>
            </div>
            <div class="col-xs-6 col-sm-6">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12">
              <div class="form-group">
                <label for="txtempfecbajae" class="control-label">Apellido: </label>
                <input type="text" name="txtempfecbajae" id="txtempfecbajae" value="<?php echo $fecha_actual; ?>" class="form-control form-control-sm" required />
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12">
              <div class="form-group">
                ...
                <input type="email" name="txtempfecbajae" id="txtempfecbajae" value="<?php echo $fecha_actual; ?>" class="form-control form-control-sm" required />
              </div>
            </div>
          </div>
        </div>
