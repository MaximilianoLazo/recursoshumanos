<form id="frm-lugardetrabajodeshabilitar" action="?c=tarea&a=DeshabilitarTarea" method="post" enctype="multipart/form-data">
  <div class="modal fade" id="dataDeleteTarea" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
