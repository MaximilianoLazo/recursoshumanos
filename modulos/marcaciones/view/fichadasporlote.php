...
<body>
              ...
              -->
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Fichadas por Lote</h5>
						</div>
					</div>
					<div class="row">
	              ...
	              <select name="CboSecretarias" id="CboSecretarias" class="custom-select form-control" required>
	                <option value="">--SELECCIONE--</option>
	                  ...
	                  <?php endforeach; ?>
						...
						<div class="col-xs-3 col-sm-3">
	            <div class="form-group">
	              <label for="CboLugaresDeTrabajo" class="control-label">Seleccione Lugar de Trabajo:</label>
	...
	<script src="includes/js/fichadasporlote.js"></script>
	<script>
      ...
      */
        ...
        var cbotipodecontrato = jQuery("#CboTipoDeContrato").val();
          ...
          "CboTipoDeContrato" : cbotipodecontrato,
				...
				$.ajax({
					data:  params,
					url:   'view/fichadasporlote-respuesta.php',
					dataType: 'html',
					type:  'post',
					beforeSend: function () {
