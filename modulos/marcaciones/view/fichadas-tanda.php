...
<body>
	...
	<?php include("includes/mdl/fichadas-tanda-archivar.php");?>
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Fichadas por Tanda</li>
								</ol>
							</nav>
						</div
					</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="row">
						<table class="data-table table-bordered stripe hover nowrap">
							...
							<tbody>
							 <?php
							 	foreach($this->model->FichadasTandaListar() as $row):
							 ...
							 ?>
		                       ...
		                       data-toggle="modal"
		                       data-target="#FichadasTandaEditar"
		                       data-titulo="<?php echo "EDITAR TANDA"; ?>"
		                       data-tandaid="<?php echo $row->mtanda_id; ?>"
													 data-tandanom="<?php echo $row->mtanda_nombre; ?>"
													 data-tandafd="<?php echo $row->mtanda_fecha_desde; ?>"
													 data-tandafh="<?php echo $row->mtanda_fecha_hasta; ?>"
													 data-tandafp="<?php echo $row->mtanda_fecha_proceso; ?>">
		                       <i class="ion-edit fa-lg"></i>
												...
												<?php
													if($row->mtanda_estado == 1){
														?>
															<!--
															<a class="dropdown-item" href="?c=marcacion&a=FichadasTandaDescarga&id=<?php //echo $row->mtanda_archivo; ?>"><i class="ion-edit fa-lg"></i>&nbsp;&nbsp;&nbsp;Editar</a>-->
															<a class="dropdown-item" href="?c=marcacion&a=FichadasTandaDescarga&id=<?php echo $row->mtanda_archivo; ?>"><i class="fi-prohibited fa-lg" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Eliminar</a>
														<?php
													}
												?>
												<?php
													if($row->mtanda_estado == 2){
														?>
															...
															<a href="#"
																 class="dropdown-item"
					                       data-toggle="modal"
					                       data-target="#FichadasTandaArchivar"
					                       data-titulo="<?php echo "ARCHIVAR TANDA"; ?>"
					                       data-tandaid="<?php echo $row->mtanda_id; ?>">
