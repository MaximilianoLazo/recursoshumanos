<?php
  ...
  $empleadofichadassinprocesar = $fichadolotel->ObtenerFichadasSinProcesar($nrodocto, $fechainicial, $fechafinal);
  ...
  <table width="100%" class="tablanovedades">
    ...
    foreach($periodofechas as $periodofecha){
      ...
      $feriadosdiaactual = $fichadolotel->ObtenerFeriadosDia($fechasql);
      $licenciasempleadodia = $fichadolotel->ObtenerLicenciasDia($fechasql, $nrodocto);
      ...
      $fichadasempleadoc = $fichadolotel->ObtenerFichadaDia($fechasql, $nrodocto);
      $fichadasdia = $fichadolotel->ObtenerMarcacionesDia($fechasql, $nrodocto);
    ...
    foreach($empleadofichadassinprocesar as $row){
      ...
      $html.='
        <tr>
          ...
          $fichadasinprocesardia = $fichadolotel->ObtenerFichadasSinProcesarDia($nrodocto, $fechamuestra3);
