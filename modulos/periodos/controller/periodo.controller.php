...
if(!isset($_SESSION["usuario_id"])){
  header("../periodos/login/index.php");
}
class PeriodoController{
    ...
    public function DeshabilitarR(){
      ...
      header("Location: index.php?c=legajos&a=Crud&id=$des->EmpId&startIndex=3");
    }
    public function GuardarH(){
        ...
        header("Location: index.php?c=legajos&a=Crud&id=$hjo->Empid&startIndex=5");
    ...
    public function GuardarEs(){
        ...
        header("Location: index.php?c=legajos&a=Crud&id=$est->Empid&startIndex=2");
    ...
    public function GuardarE(){
        ...
        header("Location: index.php?c=legajos&a=Crud&id=$empg->Id&startIndex=0");
